...
//////////////////////////////////////////////////////////
// ADD TO FILE -> includes/class-pcea-activator.php
// To create the datebase on plugin activation
...
public static function create_db_tables() {
    ...
    $plugin_name_db_version = get_option( 'pcea_db_version', '1.0' );
    ...
    if( $wpdb->get_var( "show tables like '{$table_name}'" ) != $table_name ||
        ...
        add_option( 'pcea_db_version', $plugin_name_db_version );
...
///////////////////////////////////////////////////
// ADD TO FILE -> admin/class-pcea-admin.php
// - OR -
// ADD TO FILE -> public/class-pcea-public.php
// - ETC... -
